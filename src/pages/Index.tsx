        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mt-12">
            <Button
              ...
              size="lg"
              className="rounded-full animate-fade-up"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p
              ...
              style={{ animationDelay: "0.1s" }}
            >
              A simple process to connect with qualified tutors and start
              learning.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative">
                <span className="absolute -top-10 right-0 text-6xl font-bold text-primary/10">
                  1
                </span>
                <h3 className="text-xl font-semibold mb-3">Search & Filter</h3>
                <p className="text-muted-foreground">
                  Find tutors based on subject, location, price, and
                  availability that match your requirements.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground">
                  Message tutors to discuss your learning goals and confirm
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground">
                  Schedule sessions at convenient times and start your
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p
              ...
              style={{ animationDelay: "0.1s" }}
            >
              Browse our selection of qualified tutors and find the one who
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tutors.map((tutor, index) => (
              <TutorCard key={tutor.id} {...tutor} delay={0.1 * (index % 3)} />
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="glass rounded-3xl p-8 md:p-12 text-center max-w-4xl mx-auto animate-fade-up">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              match and improved their academic performance.
            </p>
