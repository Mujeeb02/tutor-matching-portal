...
import { Calendar, Download, DollarSign, ArrowUp, ArrowDown, CreditCard, Filter, Clock } from "lucide-react";
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">{earningsData.totalEarnings}</h3>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">{earningsData.pendingPayouts}</h3>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">{earningsData.totalSessions}</h3>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2">
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`h-10 w-10 rounded-full flex items-center justify-center ${
                      ...
                      {transaction.type === "withdrawal" ? (
                        ...
                        <CreditCard className={`h-5 w-5 ${transaction.status === "pending" ? "text-yellow-500" : "text-green-500"}`} />
                      ) : (
                        <DollarSign className={`h-5 w-5 ${transaction.status === "pending" ? "text-yellow-500" : "text-green-500"}`} />
                      )}
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        {transaction.student && (
                          <span className="text-sm text-muted-foreground">{transaction.student}</span>
                        )}
                        {transaction.status === "pending" && (
                          <Badge variant="outline" className="ml-2 text-yellow-500 text-xs">Pending</Badge>
                        )}
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className={`font-medium ${transaction.amount < 0 ? "text-destructive" : ""}`}>
          ...
          <CardFooter className="border-t pt-6 flex justify-between">
            <p className="text-sm text-muted-foreground">Showing last 6 transactions</p>
